...
probing_frequencies = ['.5','.7','1','2','','4','','6','','8','','10','','12','','14','','16',
...
ax1.bar(bar_l, blue_data, width=bar_width,label='Controller-Switch', alpha=0.9, color='#4d4d4d')
ax1.bar(bar_l, red_data, width=bar_width, bottom=blue_data, label='Switch-Controller', alpha=0.9, color='#999999')
...
ax2.bar(bar_l, blue_data, width=bar_width,label='CPU (%)', alpha=0.9, color='#4d4d4d')
...
ax2.set_xlabel("(b) Monitoring interval (s)")
