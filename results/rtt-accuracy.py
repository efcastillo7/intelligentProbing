...
blue_data = [40.0,48.3,28.3,61.6,76.6,85.0,68.3,61.6,50.0,41.6,41.5,48.3,47.8,50.0,46.6,33.3]
...
plt.text(3, 30, r'Accuracy higher than 40%', fontdict=font)
