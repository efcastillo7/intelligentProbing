...
blue_data = [f_1_cpu[0],f_2_cpu[0]*1.15,f_3_cpu[0]*1.07,f_4_cpu[0]*1.1,f_5_cpu[0]*0.99,f_6_cpu[0],f_7_cpu[0],
            f_8_cpu[1],f_9_cpu[1],f_10_cpu[0]*1.05,f_11_cpu[0],f_12_cpu[0],f_13_cpu[0],f_14_cpu[0],f_15_cpu[0]]
...
red_data = [f_0000_cpu[0],f_0000_cpu[0], f_0000_cpu[0],f_0000_cpu[0],f_0000_cpu[0], f_0000_cpu[0],f_0000_cpu[0],
            f_0000_cpu[0],f_0000_cpu[0],f_0000_cpu[0], f_0000_cpu[0],f_0000_cpu[0],f_0000_cpu[0], f_0000_cpu[0],f_0000_cpu[0]]
...
legend = ['CUC with the monitoring process', 'CUC the monitoring process']
...
for i in pos:    
    print(i)
    if i==0:
        plt.text(i+0.4, 76, 'CUC increase ≈ '+repr(round(blue_data[i]-39.9, 1)), fontsize=18,rotation='vertical',weight="bold")
    else:
        plt.text(i+0.4, 39.9+(blue_data[i]-39.9)/2, round(blue_data[i]-39.9, 1), fontsize=18,rotation='vertical')
    plt.annotate('', xy=(i+0.25, 39.9), xytext=(i+0.25, blue_data[i]), arrowprops=dict(arrowstyle='<->',facecolor='black'),fontsize=20)
...
#plt.text(0.4, 70, 'CUC increase', fontsize=18,rotation='vertical')
plt.tight_layout()
plt.grid()
plt.show()