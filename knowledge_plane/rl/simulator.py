...
class Simulator(object):
	...
	def save_load_cpu(self):
		...
		if self.inRange_load(self.load_rx+self.load_tx,75,80):
		...
		elif self.inRange_load(self.load_rx+self.load_tx,75,80):
			load_state = "load_a"	
			...
			load_state = "load_g"
		elif self.inRange_load(self.load_rx+self.load_tx,40,44):
			load_state = "load_h"
	...
	def inRange_load(self,x,lowerbound, upperbound):

		x = Bytes_to(x)		
		speed = int(self.speed_nic())
