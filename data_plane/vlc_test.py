...
sd_flow_filepath = '/var/www/videoplayback.mp4' #'/home/sumanth/sample/360x240_2mb.mp4'
hd_flow_filepath = '/var/www/video_prueba.mp4' #'/home/sumanth/sample/720x480_5mb.mp4'
...
def vlcTest():
    ...
    controller=partial(RemoteController, ip='192.168.190.60', port=6633))
...
#https://github.com/sumanth232/vlc-streaming-mininet/blob/master/myvlctest.py